...
<div class="container">
    <div class="col-md-12">
        <h3 class="ops-title">Userの登録ページ</h3>
    </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nickname" type="nickname" class="form-control @error('nickname') is-invalid @enderror" name="nickname" required autocomplete="nickname">
